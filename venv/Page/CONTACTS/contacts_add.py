...
class ContactsAdd(BasePage):
    ...
    def contacts_new(self,username,englishname):
        ...
        # self._driver.find_elements_by_xpath('//*[@class="qui_dialog ww_dialog qui_dialog ww_dialog ww_dialog_NoWidthLimit multiselect_dialog hidden_checkbox"]').click()
        # self._driver.find_elements_by_xpath('//*[@class="member_tag_list_item js_tag_item"]')[1].click()
